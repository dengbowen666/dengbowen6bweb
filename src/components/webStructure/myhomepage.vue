...
>
  ...
  <div  style="margin-top: 100px;"> <router-link to="/" style="margin: auto;">
    日历
  </router-link></div>
...
{url: './src/assets/img/Carousel/golden.jpg'},
{ url: './src/assets/img/Carousel/R.jpg' },
{ url: './src/assets/img/Carousel/firewoman.jpg' },
])
